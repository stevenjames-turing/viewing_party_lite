...
@user3 = User.create!(name: 'Ashley', email: 'Ashley@example.com', password: 'test', password_confirmation: 'test')
@user4 = User.create!(name: 'Colton', email: 'Colton@example.com', password: 'test', password_confirmation: 'test')
...
@user7 = User.create!(name: 'Peter', email: 'Peter@example.com', password: 'test', password_confirmation: 'test')
@user8 = User.create!(name: 'Natasha', email: 'Natasha@example.com', password: 'test', password_confirmation: 'test')
@user9 = User.create!(name: 'Diana', email: 'Diana@example.com', password: 'test', password_confirmation: 'test')
@user10 = User.create!(name: 'Clint', email: 'Clint@example.com', password: 'test', password_confirmation: 'test')
